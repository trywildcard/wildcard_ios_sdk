...
@interface YTPlayerView() <WKScriptMessageHandler>
@end
...
- (BOOL)loadWithPlayerParams:(NSDictionary *)additionalPlayerParams {
  ...
  NSError *error = nil;
  NSString *path = [[NSBundle wildcardSDKBundle] pathForResource:@"YTPlayerView-iframe-player"
                                                   ofType:@"html"];
...
- (void)userContentController:(WKUserContentController *)userContentController
    ...
    NSURL * ytCallbackUrl = [NSURL URLWithString:message.body];
    if(ytCallbackUrl){
        [self notifyDelegateOfYouTubeCallbackUrl:ytCallbackUrl];
    }
}
